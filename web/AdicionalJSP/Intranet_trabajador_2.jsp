...
<html>
    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="#" data-target="#Empleados" class="icon-a"><i class="fa fa-users icons"></i>&nbsp;&nbsp;Pedidos</a>
                ...
                <div class="box-8">
                    <div class="content-box">
                        ...
                        <table class="table table-dark table-striped table-hover table_id" id="tblClientes">
                                ...
                                <% 
                                List<Detalle_CompraA> listdt = compDao.mostrarCompraTodo();
